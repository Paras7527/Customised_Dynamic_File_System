...
void man(char *name)
{
    ...
    else if(strcmp(name,"read")==0)
    {
        ...
        printf("Usage:rwad File_name No_Of_Bytes_To_Read\n");
    }
    ...
    {
        printf("Descirtion:Used to list all information of files\n");
        printf("Usage:ls\n");
    }
...
void DisplayHelp()
{
    ...
    printf("closeal;:To close the all opened files\n");
    printf("read:To read all the contents into file\n");
...
int fstat_file(int fd)
{
    ...
    printf("\n--------Statical Informayion About File----------\n");
    printf("File Name:%s\n", temp->FileName);
    ...
    while (1)
    {
        ...
        else if(count==4)
        {
            if(strcmp(command[0],"lseek")==0)
            {
                ...
                if(ret==-1)
                {
                    printf("ERROR:Unable ro perform lseek\n");
                }
            }
            else
            {
